...
from api.models import User, Class, Assignment, AssignmentSubmission, AssignmentGroup, AssignmentSubmissionComment, AssignmentSubmissionFile, AssignmentDeadlineExtension
...
class AssignmentDeadlineExtensionSerializer(serializers.ModelSerializer):
    user = UserSerializer(read_only=True)

    class Meta:
        model = AssignmentDeadlineExtension
        fields = ("id", "assignment", "user", "extended_submission_deadline", "created_at")
