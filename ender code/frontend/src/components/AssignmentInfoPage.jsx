...
import styles from "../styles/AssignmentInfoPage.module.css";

// Displays submission and commenting status for a selected assignment.
// Allows navigating to submit code or view peer comments.
// Props received through `location.state`: user, assignment.
  ...
  if (!assignment || !user) {
    return (
      <div style={{ padding: "2rem", fontFamily: "sans-serif" }}>
        <h2>Error: Missing assignment or user data</h2>
        ...
        <button
          ...
          onClick={async () => {
            try {
              ...
              if (!fileRes.ok)
                throw new Error(`Failed to fetch file ${file.id}`);
              ...
              navigate("/code-view", {
                state: {
                  ...
                  code: fileText,
                  assignmentId: id,
                  commentingDeadline: assignment.commenting_deadline,
                },
              });
            } catch (err) {
